...
$(window).on('load', function() {//main
    ...
    let x_data_t = numeric.linspace(0, 1, size);
    let x_data =  math.add(-1,x_data_t);
    let y_data = numeric.linspace(-1, 1, size);
    ...
    function plot_data() {//plot traces
        ...
        if (condition === "incident") {
            ...
            //console.log(math.add(getData_wave_incident(),getData_wave_reflected()));
    ...
    function initial() {
        ...
        dom.aSlider.on("change", update_graph);
